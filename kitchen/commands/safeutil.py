...
-Original code done by  http://alexwlchan.net/2015/06/safer-file-copying/
-Modified code done by globz
"""
...
def _increment_filename(filename, marker='-'):
    ...
    For example:
        ...
        f1 = increment_filename("myscript.sh")
        f1.next() # myscript-1.sh
        f1.next() # myscript-2.sh
        f1.next() # myscript-3.sh
    ...
    For example:
        ...
        f2 = increment_filename("myfile-3.php")
        f2.next() # myfile-4.php
        f2.next() # myfile-5.php
        f2.next() # myfile-6.php

    The default marker is an underscore, but you can use any string you like:

        f3 = increment_filename("myfile.js", marker="_")
        f3.next() # myfile_1.js
        f3.next() # myfile_2.js
        f3.next() # myfile_3.js
